...
def parse_data(data_dir='./data'):
    ...
    # the data is structured in subdirs, each containing specific experience for easier management
    # the logs are preprocessed to contain the local paths
...
if __name__ == "__main__":
    ...
    # set batch size
    # batch size is halved because the augmented images will be added to each batch,
    #  resulting in the original batch size
    batch_size = 32
    batch_size //= 2

    # parse the data to a list of (X, y) pairs
    print("Parsing data...")
